...
export const translations = {
  en: {
    ...
    partnerForm: {
      ...
      title: "Enquire Now —",
      titleSpan: "We'll Get Back to You",
      sub: "Fill in your details and our partner success team will reach out within 24 hours with a personalised partnership plan.",
      nameLabel: "Your Name",
      namePlaceholder: "e.g. Dr. Priya Mehta",
      phoneLabel: "Contact Number",
      phonePlaceholder: "+91 98765 43210",
      clinicLabel: "Clinic / Practice Name",
      clinicPlaceholder: "e.g. Mehta Nutrition Clinic",
      commentsLabel: "Comments (optional)",
      commentsPlaceholder: "Tell us about your practice, client volume, or any specific requirements...",
      ...
      successSub: "Your details are pre-filled in the message. Just hit send and we'll get back to you shortly! 🚀",
      successReset: "Submit another enquiry",
      privacy: "Your details will be shared with Nosh7 via WhatsApp only. We respect your privacy.",
    },
    footer: {
  ...
  hinglish: {
    ...
    partnerForm: {
      badge: "🤝 Partnership Shuru Karo",
      title: "Abhi Enquire Karo —",
      titleSpan: "Hum Contact Karenge",
      sub: "Apni details bharo — hamaari partner success team 24 ghante mein personalised plan ke saath contact karegi.",
      nameLabel: "Aapka Naam",
      namePlaceholder: "jaise Dr. Priya Mehta",
      phoneLabel: "Contact Number",
      phonePlaceholder: "+91 98765 43210",
      clinicLabel: "Clinic / Practice ka Naam",
      clinicPlaceholder: "jaise Mehta Nutrition Clinic",
      commentsLabel: "Comments (optional)",
      commentsPlaceholder: "Apni practice, clients ya requirements ke baare mein batao...",
      submit: "💬 WhatsApp pe Enquiry Bhejo",
      nameRequired: "Naam zaroori hai",
      phoneRequired: "Contact number zaroori hai",
      clinicRequired: "Clinic ka naam zaroori hai",
      phoneInvalid: "Valid phone number dalein",
      successTitle: "WhatsApp khul raha hai…",
      successSub: "Aapki details message mein bhar di gayi hain. Bas send karo aur hum jald hi contact karenge! 🚀",
      successReset: "Dobaara enquiry bhejo",
      privacy: "Aapki details sirf WhatsApp ke zariye Nosh7 ke saath share hongi. Hum aapki privacy ka samman karte hain.",
    },
    footer: {
      location: "📍 Satellite, Ahmedabad, Gujarat 🇮🇳",
  ...
  hi: {
    ...
    partnerForm: {
      badge: "🤝 पार्टनरशिप शुरू करें",
      title: "अभी पूछताछ करें —",
      titleSpan: "हम संपर्क करेंगे",
      sub: "अपनी जानकारी भरें — हमारी पार्टनर सक्सेस टीम 24 घंटे में व्यक्तिगत प्लान के साथ संपर्क करेगी।",
      nameLabel: "आपका नाम",
      namePlaceholder: "जैसे डॉ. प्रिया मेहता",
      phoneLabel: "संपर्क नंबर",
      phonePlaceholder: "+91 98765 43210",
      clinicLabel: "क्लिनिक / प्रैक्टिस का नाम",
      clinicPlaceholder: "जैसे Mehta Nutrition Clinic",
      commentsLabel: "टिप्पणियां (वैकल्पिक)",
      commentsPlaceholder: "अपनी प्रैक्टिस, क्लाइंट्स या विशेष आवश्यकताओं के बारे में बताएं...",
      submit: "💬 WhatsApp पर पूछताछ भेजें",
      nameRequired: "नाम आवश्यक है",
      phoneRequired: "संपर्क नंबर आवश्यक है",
      clinicRequired: "क्लिनिक का नाम आवश्यक है",
      phoneInvalid: "वैध फ़ोन नंबर दर्ज करें",
      successTitle: "WhatsApp खुल रहा है…",
      successSub: "आपकी जानकारी संदेश में भर दी गई है। बस भेजें और हम जल्द ही संपर्क करेंगे! 🚀",
      successReset: "फिर से पूछताछ करें",
      privacy: "आपकी जानकारी केवल WhatsApp के ज़रिए Nosh7 के साथ साझा की जाएगी। हम आपकी गोपनीयता का सम्मान करते हैं।",
    },
    footer: {
  ...
  gu: {
    ...
    partnerForm: {
      badge: "🤝 Partnership Sharu Karo",
      title: "Hame Puchho —",
      titleSpan: "Ame Sampark Karishu",
      sub: "Tamari mahiti bharo — amari partner success team 24 kalakmaa personalised plan sathe sampark karishe.",
      nameLabel: "Tamaru Naam",
      namePlaceholder: "jeva ke Dr. Priya Mehta",
      phoneLabel: "Contact Number",
      phonePlaceholder: "+91 98765 43210",
      clinicLabel: "Clinic / Practice nu Naam",
      clinicPlaceholder: "jeva ke Mehta Nutrition Clinic",
      commentsLabel: "Comments (vaikalpatik)",
      commentsPlaceholder: "Tamari practice, clients ya koi khas jaruriyat vishye janaavo...",
      submit: "💬 WhatsApp par Enquiry Moko",
      nameRequired: "Naam jaroori che",
      phoneRequired: "Contact number jaroori che",
      clinicRequired: "Clinic nu naam jaroori che",
      phoneInvalid: "Valid phone number nakhvo",
      successTitle: "WhatsApp khuli rahyu che…",
      successSub: "Tamari mahiti message maa bhari devi che. Bas send karo ane ame jald sampark karishu! 🚀",
      successReset: "Fari enquiry karo",
      privacy: "Tamari mahiti fakt WhatsApp dvara Nosh7 sathe share thashe. Ame tamari privacy nu samman kariye chie.",
    },
    footer: {
      location: "📍 Satellite, Ahmedabad, Gujarat 🇮🇳",
